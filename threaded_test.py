...
NAO_IP = "10.50.20.179" # default, for running on Pepper
NAO_PORT = 9559
...
CALIBRATION_DURATION = 2    # 3 seconds, timespan during which calibration is performed (summing up RMS values and calculating mean)
CALIBRATION_THRESHOLD_FACTOR = 0.5  # 2.15 factor the calculated mean RMS gets multiplied by to determine the auto detection threshold (after calibration)

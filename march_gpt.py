...
input_file_path = "/home/cmpuser1/naoqi/pepper_mod2/pepper_text.json"  # Replace with the actual path to your text file
output_file_path = "/home/cmpuser1/naoqi/pepper_mod2/response.txt"  # Replace with the desired output file path

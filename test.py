...
def main(session, faceSize):
    ...
    a = tracker_service.getSupportedTargets()
    b = tracker_service.getTargetNames()
    c = tracker_service.getTargetCoordinates()
    ...
    try:
        while True:
            #print('Supported Targets : ',a)
            #print('Targets Name : ',b)
            print('Target coor : ',c)
            time.sleep(1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="10.50.20.10",
